...
YOUTUBETRANSCRIPT_API_KEY=your_youtubetranscript_dev_api_key
...
- Transcript extraction uses `YOUTUBETRANSCRIPT_API_KEY` and the hosted YouTubeTranscript.dev API. This keeps YouTube handling outside Render.
